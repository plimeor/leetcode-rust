...
#[test]
fn test() {
    assert_eq!(Solution::max_consecutive_answers(String::from("TTFF"), 2), 4);
    assert_eq!(Solution::max_consecutive_answers(String::from("TFFT"), 1), 3);
    assert_eq!(Solution::max_consecutive_answers(String::from("TTFTTFTT"), 1), 5);
}
